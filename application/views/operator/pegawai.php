									...
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<select name="akses" required="" class="form-control">
												<option value="">----</option>
												<option <?php if($key->akses=="Operator"){echo "selected";} ?> value="Operator">Admin</option>
												<option <?php if($key->akses=="Staff"){echo "selected";} ?> value="Staff">Auditor</option>
												<option <?php if($key->akses=="Kepala"){echo "selected";} ?> value="Kepala">Pimpinan</option>
												<option <?php if($key->akses=="Kasubag"){echo "selected";} ?> value="Kasubag">Supervisor</option>
											</select>
										</div>
									</div>
									<div class="col-md-6">
